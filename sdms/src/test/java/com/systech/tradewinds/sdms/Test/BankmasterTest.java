...
public class BankmasterTest extends BasePage {
	...
	public void insertbankmstr(String Benificary,String accNo,String BankAlias,String BankName,String Branch,String Ifsccode,String Swiftcode) {
		...
		txtData(bankmaster.getBankName(),accNo);

		selectBytext(bankmaster.getBankName(), BankAlias);
