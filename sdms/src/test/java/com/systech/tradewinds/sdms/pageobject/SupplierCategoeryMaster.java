...
public class SupplierCategoeryMaster  extends BasePage {

	public SupplierCategoeryMaster() {
		PageFactory.initElements(driver, this);
	}

	// Url
	private String pageUrl = "http://localhost:8081/SDMS/pages/masters/SupplierCategoryMaster.xhtml ";


	@FindBy(xpath="//*[@id=\'chgtype:tabviewid:supplierCategoryId']")
