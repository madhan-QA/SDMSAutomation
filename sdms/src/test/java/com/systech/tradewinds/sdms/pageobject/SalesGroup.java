...
public class SalesGroup extends BasePage{
	...
	// Url
	private String pageUrl = "http://localhost:8081/SDMS/pages/masters/SalesGroupMaster.xhtml ";


	@FindBy(xpath="//*[@id=\'chgtype:tabviewid:salesGroupNameId']")
	private WebElement SalesGrp;
