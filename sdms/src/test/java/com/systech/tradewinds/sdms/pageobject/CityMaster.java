...
public class CityMaster extends BasePage {
	...
	//Bankmaster Url
	private String pageUrl = "http://localhost:8081/SDMS/pages/masters/citymaster.xhtml ";

	@FindBy(xpath="//*[@id=\'chgtype:tabviewid:state_input']")
	private WebElement statename;

	@FindBy(xpath="//*[@id=\'chgtype:tabviewid:cityName']")
